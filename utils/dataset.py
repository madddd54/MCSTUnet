...
import utils.data_enhancement as enhancement
...
class COVIDDataset(data.Dataset):
    def __init__(self, image_root, gt_root, trainsize):
        ...
        self.img_transform = transforms.Compose([
            ...
            # transforms.Normalize(mean=[0.36047527, 0.36047527, 0.36047527], std=[0.22624598, 0.22624598, 0.22624598])])
...
def get_loader(image_root, gt_root, batchsize, trainsize, shuffle=True, num_workers=0, pin_memory=True):
    dataset = COVIDDataset(image_root, gt_root, trainsize)
...
class test_dataset:
    def __init__(self, image_root: object, gt_root: object, testsize: object) -> object:
